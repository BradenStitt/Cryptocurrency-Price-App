...
def round_value(input_value):
    if input_value.values > 1:
        # Round to 2 decimal places if USD value of coin is greater than $1
        a = float(round(input_value, 2))
    else:
        # Round to 8 decimal places if USD value of coin is less than $1
...
# Widget (Cryptocurrency selection sidebar)
